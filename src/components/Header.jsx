...
const Header = () => {
    ...
    return (
      <div className="fixed top-0 left-0 w-full z-50 bg-zinc-950/90 backdrop-blur-sm broder-b border-zinc-800 lg:bg-zinc-950/90 lg:backdrop-blur-sm lg:border-zinc-800">
