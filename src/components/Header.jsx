...
const Header = () => {
    ...
    return (
      <div className={`fixed top-0 left-0 w-full z-50 broder-b border-gray-700 lg:bg-zinc-950/90 lg:backdrop-blur-sm lg:border-zinc-800 ${openNavigation ? "bg-zinc-950" : "bg-zinc-950/90 backdrop-blur-sm"}`}>
        ...
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
            ...
            <a href="#signup" className="text-xs font-bold uppercase tracking-wider hidden mr-8 text-white/50 transition-colors hover:text-white lg:block">New Account</a>
